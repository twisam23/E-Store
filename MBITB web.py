...
class StartDialog:
    ...
    def create_start_dialog(self):
        try:
            image_path = "C:/Users/vyoma/Downloads/excelapp-main (1)/excelapp-main/E STORE-logos.jpeg"
            ...
            print(f"Error in create_start_dialog: {e}")
    ...
    def load_main_application(self):
        try:
            ...
            print(f"Error loading main application: {e}")
